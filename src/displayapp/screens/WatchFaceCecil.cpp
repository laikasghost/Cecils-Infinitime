//TODO: replace day of year with weather from terminal face
...
WatchFaceCecil::WatchFaceCecil(Controllers::DateTime& dateTimeController,
  ...
  lv_obj_set_style_local_text_color(label_battery_value, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, color_line);
  lv_label_set_text_static(label_battery_value, "00%");

  batteryIcon.Create(lv_scr_act());
  batteryIcon.SetColor(color_line);
